...
def signal_handler(sig, frame):
	...
	# disable the servos
	pi.set_sefvo_pulsewidth(servo_1,0)
...
def set_servos(pan, tlt):
	...
	while True:
		...
		if in_range(panAngle, servoRange[0], servoRange[1]):
			panAngle_1=converter(panAngle)
			pi.set_servo_pulsewidth(servo_1,panAngle_1)

		# if the tilt angle is within the range, tilt
		if in_range(tiltAngle, servoRange[0], servoRange[1]):
			tiltAngle_1=converter(tiltAngle)
			pi.set_servo_pulsewidth(servo_2,tiltAngle_1)
